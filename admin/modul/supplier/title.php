...
<head>
    ...
    <meta name="description" content="Data Supplier Inventory">
    <meta name="author" content="Fakhri afkar">
    <title><?php echo isset($judul) ? $judul : 'Data Supplier'; ?></title>
...
<body>
    ...
    <div class="main-content" id="content">
        ...
        <nav class="top-navbar">
            ...
            <h4 class="mb-0 fw-bold text-secondary">Data Supplier</h4>
        ...
        <div class="container-fluid p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4" data-aos="fade-down">
                <div>
                    <h5 class="text-muted mb-0">Manajemen Vendor</h5>
                    <h2 class="fw-bold text-dark">Daftar Supplier</h2>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        <thead class="table-dark">
                            <tr>
                                <th class="py-3 ps-3 rounded-start">ID Supplier</th>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title fw-bold" id="exampleModalLongTitle"><i class="fas fa-truck-loading me-2"></i> Tambah Supplier Baru</h5>
                ...
                <form action="?m=supplier&s=simpan" method="POST" enctype="multipart/form-data">
                    <div class="modal-body p-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nama_sup" placeholder="Masukkan Nama Perusahaan/Supplier" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">Kontak Person</label>
                            <input type="text" class="form-control" name="kontak_sup" placeholder="Nama Penanggung Jawab">
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">Telepon</label>
                            <input type="text" class="form-control" name="telepon_sup" placeholder="Contoh: 021-xxxxxx atau 0812xxxx">
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">Alamat Lengkap</label>
                            <textarea class="form-control" name="alamat_sup" rows="3" placeholder="Masukkan Alamat Kantor Supplier"></textarea>
                        </div>
                    </div>
