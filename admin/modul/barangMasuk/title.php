...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <a href="?m=barangMasuk&s=awal" class="active"><i class="fas fa-cart-arrow-down"></i> Barang Masuk</a> 
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg"> <div class="modal-content border-0 shadow-lg">
                ...
                <form action="?m=barangMasuk&s=simpan" method="POST" enctype="multipart/form-data">
                    <div class="modal-body p-4">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3"> <label class="form-label fw-bold">Tanggal Masuk</label> <input type="text" class="form-control" name="tanggal" value="<?php echo $tanggalSekarang; ?>" readonly> </div>
                                <div class="mb-3"> <label class="form-label fw-bold">Jam</label> <input type="text" class="form-control" name="jam" value="<?php echo $jamSekarang; ?>" readonly> </div>
                                <div class="mb-3"> <label class="form-label fw-bold">No. Invoice</label> <input type="text" class="form-control" name="noinv" placeholder="Contoh: INV/2025/001" required> </div>
                                <div class="mb-3"> <label class="form-label fw-bold">Admin Bertugas</label> <input type="text" class="form-control" name="petugas" value="<?php echo $r['nama']; ?>" readonly> </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-6 mb-3"> <label class="form-label fw-bold">Stok Awal</label> <input type="text" class="form-control bg-light" name="stok" id="prd_stk" readonly> </div>
                                    <div class="col-6 mb-3"> <label class="form-label fw-bold">Jml Masuk</label> <input type="number" class="form-control border-success" name="jml_masuk" placeholder="0" required> </div>
                                </div>
                                <div class="mb-3"> <label class="form-label fw-bold">Supplier</label> <input type="text" class="form-control bg-light" name="supplier" id="prd_sup" readonly> </div>
                            </div>
                        </div>
                    </div>
