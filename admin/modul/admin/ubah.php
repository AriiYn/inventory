...
<head>
    ...
    <title>Edit Data Admin | Fakhri afkar</title>
    ...
    <style>
        ...
        /* Sidebar & Layout Styles (Sama seperti halaman sebelumnya) */
        .sidebar {
            min-height: 100vh;
            width: 260px;
            background: #2c3e50;
...
<body>
    ...
    <div class="main-content" id="content">
        ...
        <nav class="top-navbar">
            ...
            <h4 class="mb-0 fw-bold text-secondary">Edit Admin</h4>
                ...
                <div class="col-lg-8 col-md-10">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4" data-aos="fade-down">
                        <div>
                            ...
                            <h2 class="fw-bold text-dark">Perbarui Data Admin</h2>
                        </div>
                        <a href="?m=admin&s=awal" class="btn btn-outline-secondary rounded-pill">
                        ...
                        <form action="?m=admin&s=update" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="username" value="<?php echo $r['username']; ?>" placeholder="Masukkan Username">
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="telepon" value="<?php echo $r['telepon']; ?>" placeholder="Masukkan Nomor Telepon">
                                </div>
                                    ...
                                    <div class="p-3 bg-light rounded border">
                                        <div class="d-flex align-items-start">
                                            <div class="me-4 text-center">
                                                ...
                                                <img src="../images/admin/<?php echo $r['foto'];?>" class="img-preview shadow-sm">
                                            </div>
                                            <div class="flex-grow-1">
                                                <label class="form-label fw-bold mb-2">Ubah Foto?</label>
                                                <div class="form-check form-switch mb-3">
                                                    <input class="form-check-input" type="checkbox" name="ubahfoto" value="true" id="flexSwitchCheckDefault">
                                                    <label class="form-check-label" for="flexSwitchCheckDefault">Ya, saya ingin mengubah foto</label>
                                                </div>
                                                <input type="file" class="form-control" name="inpfoto">
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                <a href="?m=admin&s=awal" class="btn btn-secondary me-2">Batal</a>
