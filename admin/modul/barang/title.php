...
<head>
    ...
    <meta name="description" content="Data Barang Inventory">
    <meta name="author" content="Fakhri afkar">
    <title><?php echo isset($judul) ? $judul : 'Data Barang'; ?></title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <a href="?m=barang&s=awal" class="active"><i class="fas fa-box-open"></i> Data Barang</a>
    ...
    <div class="main-content" id="content">
        ...
        <nav class="top-navbar">
            ...
            <h4 class="mb-0 fw-bold text-secondary">Data Barang</h4>
        ...
        <div class="container-fluid p-4">
            ...
            <div class="row mb-4 align-items-end" data-aos="fade-down">
                <div class="col-md-6">
                    <h5 class="text-muted mb-0">Manajemen Stok</h5>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <form action="" method="POST">
                            <div class="input-group">
                                <input type="text" name="cari" class="form-control" placeholder="Cari nama atau kode barang..." aria-label="Cari Barang">
                                <button type="submit" name="go" class="btn btn-primary"><i class="fas fa-search"></i> Cari</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        <thead class="table-dark">
                            <tr>
                                <th class="py-3 ps-3 rounded-start">Kode Barang</th>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title fw-bold" id="exampleModalLongTitle"><i class="fas fa-box me-2"></i> Tambah Data Barang</h5>
                ...
                <form action="?m=barang&s=simpan" method="POST" enctype="multipart/form-data">
                    <div class="modal-body p-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="kode_brg" maxlength="5" placeholder="Contoh: BRG01" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="rak" required>
                                ...
                                <?php 
                                    include '../koneksi.php';
                                    $sql_rak = "SELECT * FROM tb_rak";
                                    $hasil_rak = mysqli_query($koneksi, $sql_rak);
                                    while ($data_rak = mysqli_fetch_array($hasil_rak)) {
                                ?>
                                    <option value="<?php echo $data_rak['nama_rak'];?>"><?php echo $data_rak['nama_rak']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="supplier" required>
                                ...
                                <?php 
                                    include '../koneksi.php';
                                    $sql_sup = "SELECT * FROM tb_sup";
                                    $hasil_sup = mysqli_query($koneksi, $sql_sup);
                                    while ($data_sup = mysqli_fetch_array($hasil_sup)) {
                                ?>
                                    <option value="<?php echo $data_sup['nama_sup'];?>"><?php echo $data_sup['nama_sup']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    ...
                    <div class="modal-footer bg-light">
                        ...
                        <button type="submit" name="simpan" class="btn btn-success"><i class="fas fa-save me-1"></i> Simpan Data</button>
                    </div>
                </form>
            </div>
        </div>
