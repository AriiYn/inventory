...
<head>
    ...
    <meta name="description" content="Edit Data Barang">
    <meta name="author" content="Fakhri afkar">
    <title>Edit Data Barang | Fakhri afkar</title>
...
<body>
    ...
    <div class="main-content" id="content">
        ...
        <nav class="top-navbar">
            ...
            <h4 class="mb-0 fw-bold text-secondary">Edit Barang</h4>
                ...
                <div class="col-lg-8 col-md-10">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4" data-aos="fade-down">
                        <div>
                            ...
                            <h2 class="fw-bold text-dark">Perbarui Data Barang</h2>
                        </div>
                        <a href="?m=barang&s=awal" class="btn btn-outline-secondary rounded-pill">
                        ...
                        <form action="?m=barang&s=update" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control bg-light" name="kode_brg" value="<?php echo $r['kode_brg']; ?>" readonly>
                                    <small class="text-muted">Kode barang tidak dapat diubah</small>
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label class="form-label fw-bold">Nama Barang</label>
                                    <input type="text" class="form-control" name="nama_brg" value="<?php echo $r['nama_brg']; ?>" placeholder="Masukkan Nama Barang" required>
                                </div>

                                <div class="col-md-12 mb-3">
                                    <label class="form-label fw-bold">Stok Barang</label>
                                    <input type="number" class="form-control" name="stok" value="<?php echo $r['stok']; ?>" placeholder="Jumlah Stok" required>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" name="rak" required>
                                        ...
                                        ?>
                                            <option value="<?php echo $data_rak['nama_rak'];?>" <?php echo $selected; ?>>
                                                <?php echo $data_rak['nama_rak']; ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                                </div>
                                    ...
                                    <select class="form-select" name="supplier" required>
                                        ...
                                        <?php 
                                            ...
                                            while ($data_sup = mysqli_fetch_array($hasil_sup)) {
                                                // Logika Auto-Select
                                                $selected = ($data_sup['nama_sup'] == $r['supplier']) ? "selected" : "";
                                        ?>
                                            <option value="<?php echo $data_sup['nama_sup'];?>" <?php echo $selected; ?>>
                                                <?php echo $data_sup['nama_sup']; ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                <a href="?m=barang&s=awal" class="btn btn-secondary me-2">Batal</a>
