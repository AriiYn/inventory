...
<head>
    ...
    <meta name="description" content="Data Petugas Inventory">
    <meta name="author" content="Fakhri afkar">
    <title><?php echo isset($judul) ? $judul : 'Data Petugas'; ?></title>
    ...
    <style>
        ...
        .btn-add {
            background: linear-gradient(45deg, #f1c40f, #f39c12); /* Kuning Petugas */
            color: white;
            border: none;
...
<body>
    ...
    <div class="main-content" id="content">
        ...
        <nav class="top-navbar">
            ...
            <h4 class="mb-0 fw-bold text-secondary">Data Petugas</h4>
        ...
        <div class="container-fluid p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4" data-aos="fade-down">
                <div>
                    <h5 class="text-muted mb-0">Manajemen User</h5>
                    <h2 class="fw-bold text-dark">Daftar Petugas</h2>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        <thead class="table-dark">
                            <tr>
                                <th class="py-3 ps-3 rounded-start">ID Petugas</th>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-warning text-dark">
                    <h5 class="modal-title fw-bold" id="exampleModalLongTitle"><i class="fas fa-user-edit me-2"></i> Tambah Data Petugas</h5>
                ...
                <form action="?m=petugas&s=simpan" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer bg-light">
                        ...
                        <button type="submit" name="simpan" class="btn btn-warning fw-bold"><i class="fas fa-save me-1"></i> Simpan Data</button>
                    </div>
                </form>
            </div>
        </div>
