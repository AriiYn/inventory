...
<head>
    ...
    <meta name="description" content="Edit Data Petugas">
    <meta name="author" content="Fakhri afkar">
    <title>Edit Data Petugas | Fakhri afkar</title>
    ...
    <style>
        ...
        .form-control:focus {
            border-color: #f39c12; /* Warna tema petugas (kuning/orange) */
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <a href="?m=petugas&s=awal" class="active"><i class="fas fa-users"></i> Data Petugas</a>
    ...
    <div class="main-content" id="content">
        ...
        <nav class="top-navbar">
            ...
            <h4 class="mb-0 fw-bold text-secondary">Edit Petugas</h4>
                ...
                <div class="col-lg-8 col-md-10">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4" data-aos="fade-down">
                        <div>
                            ...
                            <h2 class="fw-bold text-dark">Perbarui Data Petugas</h2>
                        </div>
                        <a href="?m=petugas&s=awal" class="btn btn-outline-secondary rounded-pill">
                        ...
                        <form action="?m=petugas&s=update" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="username" value="<?php echo $r['username']; ?>" placeholder="Masukkan Username" required>
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label class="form-label fw-bold">Password</label>
                                    <input type="password" class="form-control" name="password" placeholder="Kosongkan jika tidak ingin ubah password">
                                    <small class="text-muted" style="font-size: 11px;">(Input password baru jika ingin mengubah)</small>
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label class="form-label fw-bold">Nama Petugas</label>
                                    <input type="text" class="form-control" name="nama" value="<?php echo $r['nama']; ?>" placeholder="Masukkan Nama Lengkap" required>
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label class="form-label fw-bold">Telepon</label>
                                    <input type="text" class="form-control" name="telepon" value="<?php echo $r['telepon']; ?>" placeholder="Masukkan Nomor Telepon" required>
                                </div>
                            </div>

                            <div class="d-flex justify-content-end mt-4">
                                <a href="?m=petugas&s=awal" class="btn btn-secondary me-2">Batal</a>
