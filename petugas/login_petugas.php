...
<head>
    ...
    <title>Login Petugas | Fakhri afkar</title>
    ...
    <style>
        ...
        .form-control:focus {
            box-shadow: none;
            border-color: #f1c40f; /* Kuning Petugas */
            ...
            <div class="col-md-6 col-lg-5">
                ...
                <div class="card-login" data-aos="fade-down" data-aos-duration="1000">
                    <div class="text-center login-header mb-4">
                        <i class="fas fa-clipboard-user fa-3x text-warning mb-3"></i>
                        <h3>Login Petugas</h3>
                        <p>Silakan masuk untuk mengelola inventory</p>
                    </div>
