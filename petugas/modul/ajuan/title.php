...
<head>
    ...
    <meta name="description" content="Data Ajuan Barang">
    <meta name="author" content="Fakhri afkar">
    <title><?php echo isset($judul) ? $judul : 'Data Ajuan'; ?></title>
    ...
    <style>
        ...
        .sidebar-nav a:hover, .sidebar-nav a.active { color: #fff; background: rgba(255,255,255,0.05); border-left: 4px solid #f39c12; }
        ...
        .btn-add { background: linear-gradient(45deg, #e67e22, #f39c12); color: white; border: none; box-shadow: 0 4px 6px rgba(230, 126, 34, 0.3); }
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <a href="?m=ajuan&s=awal" class="active"><i class="fas fa-gift"></i> Data Ajuan Barang Keluar</a> 
    ...
    <div class="main-content" id="content">
        ...
        <nav class="top-navbar">
            ...
            <h4 class="mb-0 fw-bold text-secondary">Data Ajuan</h4>
        ...
        <div class="container-fluid p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4" data-aos="fade-down">
                <div>
                    <h5 class="text-muted mb-0">Permintaan Barang</h5>
                    <h2 class="fw-bold text-dark">Data Pengajuan</h2>
                </div>
                <button type="button" class="btn btn-add px-4 py-2 rounded-pill" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                    <i class="fas fa-plus me-2"></i> Tambah Ajuan
                </button>
            </div>
            ...
            <div class="card-custom mb-4" data-aos="fade-up">
                <form action="" method="GET" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-2 ms-auto">
                        <a href="modul/ajuan/cetak.php?bulan=<?php echo $bulan_filter; ?>&tahun=<?php echo $tahun_filter; ?>" target="_blank" class="btn btn-print w-100">
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        <thead class="table-dark">
                            <tr>
                                <th class="py-3 ps-3 rounded-start">No Ajuan</th>
                ...
                <nav aria-label="Page navigation" class="mt-4">
                    <ul class="pagination justify-content-center">
                        <li class="page-item <?php if($halaman <= 1){ echo 'disabled'; } ?>">
                            <a class="page-link" <?php if($halaman > 1){ echo "href='?m=ajuan&s=awal&halaman=$previous&bulan=$bulan_filter&tahun=$tahun_filter'"; } ?>>Previous</a>
                        </li>
                        <?php for($x=1;$x<=$total_halaman;$x++){ ?> 
                            <li class="page-item <?php if($halaman == $x) echo 'active'; ?>">
                                <a class="page-link" href="?m=ajuan&s=awal&halaman=<?php echo $x ?>&bulan=<?php echo $bulan_filter; ?>&tahun=<?php echo $tahun_filter; ?>"><?php echo $x; ?></a>
                            </li>
                        <?php } ?>
                        <li class="page-item <?php if($halaman >= $total_halaman) { echo 'disabled'; } ?>">
                            <a class="page-link" <?php if($halaman < $total_halaman) { echo "href='?m=ajuan&s=awal&halaman=$next&bulan=$bulan_filter&tahun=$tahun_filter'"; } ?>>Next</a>
                        </li>
                    </ul>
                </nav>
            </div>
        ...
        <footer><p class="mb-0">Copyright &copy; <script>document.write(new Date().getFullYear());</script> <strong>Fakhri afkar</strong>. All rights reserved</p></footer>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg"> 
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-warning text-dark">
                    <h5 class="modal-title fw-bold"><i class="fas fa-file-alt me-2"></i> Form Pengajuan Barang</h5>
                ...
                <form action="?m=ajuan&s=simpan" method="POST" enctype="multipart/form-data">
                    <div class="modal-body p-4">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3"> <label class="form-label fw-bold">Nomor Ajuan</label> <input type="text" class="form-control" name="no_ajuan" placeholder="Contoh: AJ-001" required> </div>
                                <div class="mb-3"> <label class="form-label fw-bold">Tanggal</label> <input type="text" class="form-control" name="tanggal" value="<?php echo $tanggalSekarang; ?>" readonly> </div>
                                <div class="mb-3"> <label class="form-label fw-bold">Petugas Pengaju</label> <input type="text" class="form-control" name="petugas" value="<?php echo $r['nama']; ?>" readonly> </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                ...
                                <div class="mb-3"> <label class="form-label fw-bold">Nama Barang</label> <input type="text" class="form-control bg-light" name="nama_brg" id="prd_nmbrg" readonly> </div>
                                <div class="row">
                                    <div class="col-6 mb-3"> <label class="form-label fw-bold">Stok Saat Ini</label> <input type="text" class="form-control bg-light" name="stok" id="prd_stk" readonly> </div>
                                    <div class="col-6 mb-3"> <label class="form-label fw-bold">Jml Ajuan</label> <input type="number" class="form-control border-warning" name="jml_ajuan" placeholder="0" required> </div>
                                </div>
                                <input type="hidden" id="prd_sup" name="supplier">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer bg-light">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                        <button type="submit" name="simpan" class="btn btn-warning fw-bold"><i class="fas fa-save me-1"></i> Simpan Ajuan</button>
                    </div>
                </form>
            </div>
        </div>
